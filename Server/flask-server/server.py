...
# Carrega variáveis do .env do servidor
load_dotenv("/mnt/fl_clients/Server/flask-server/config_servidor.env", override=True)
...
def main():
    ...
    # Lê IP e porta do ambiente
    server_ip_env = os.environ.get("SERVER_IP", "100.127.13.111:7070")
    server_ip, server_port = server_ip_env.split(":")
    ...
    fl.server.start_server(
                                ...
                                config=fl.server.ServerConfig(num_rounds=int(num_rounds)),
                                strategy=server, 
                            )
